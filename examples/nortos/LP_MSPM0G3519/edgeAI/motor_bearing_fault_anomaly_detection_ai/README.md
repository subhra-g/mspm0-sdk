...
The class to LED color mapping is shown below:
   - **LED3 (Green)**: Class 1 (Normal)
   - **LED2 (Red)**: Class 2 (Anomaly)
...
| Input Shape | (1, 3, 128, 1) |
| Output Classes | 2 (Bearing Fault Anomaly detection) |
| Quantization | INT8 |
...
| Flash Usage | 3.24 kB |
| RAM Usage | 2.26 kB |
| Inference Latency (CPU) | 21.38 ms |
...
2. **Operation**
   ...
   - Feature vectors are fed to the AI model for bearing anomaly detection inference
...
3. **Running the Example**
   - Compile and load the application on your MSPM0G3519 device
