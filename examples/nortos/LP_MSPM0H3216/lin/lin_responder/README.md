...
LP-MSPM0H3216 LaunchPad. It showcases SUBSCRIBE frames (receive from commander),
...
Visit [LP_MSPM0H3217](https://www.ti.com/tool/LP-MSPM0H3217) for LaunchPad information, including user guide and hardware files.

| Pin  | Peripheral | Function | LaunchPad Pin | LaunchPad Settings |
| ---- | ---------- | -------- | ------------- | ------------------ |
| PB15 | GPIOB      | PB24     | J2_17         | N/A                |
| PB22 | GPIOB      | PB16     | J27_5         | <ul><li>PB22 can be connected to LED2 Blue<br><ul><li>`J5 ON` Connect to LED2 Blue<br><li>`J15 OFF` Disconnect from LED2 Blue</ul></ul> |
| PB26 | GPIOB      | PB17     | J27_8         | <ul><li>PB26 can be connected to LED2 Red<br><ul><li>`J6 ON` Connect to LED2 Red<br><li>`J6 OFF` Disconnect from LED2 Red</ul></ul> |
...
This project was developed for a superset device included in the LP_MSPM0H3217 LaunchPad. Please
...
MSPM0 LaunchPad, please visit the [LP-MSPM0H3217 User's Guide](https://www.ti.com/lit/slau951).

## Example Usage

### Hardware Setup
Connect the LP-MSPM0H3216 LaunchPad to a LIN Commander or Network Analyzer via a
...
Configure jumpers for CAN/LIN connector connection mode (J10/R62, J12/R63).
Note: The BOOSTXL-CANFD-LIN BoosterPack is not directly compatible with the
LP-MSPM0H3216 LaunchPad as the UART connector pins do not support LIN mode.
...
1. **PID 0x10 (SUBSCRIBE)**:
   ...
   - LED Blue (PB16) pulses briefly on successful reception
...
2. **PID 0x20 (PUBLISH)**:
   ...
   - LED Red (PB17) pulses briefly on successful transmission
