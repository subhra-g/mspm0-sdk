...
| GPIOA | Standard Output | PA1 | J13_9 | Populate Component(s): R15,J13 |
| SYSCTL |  |  |  |  |
| TIMG1 |  |  |  |  |
...
The transmitted data packet is {'M', 'S', 'P', 'x'}, where 'x' starts at '0' and will increment with each new transfer. LED1 will toggle every time a new transmission starts.
