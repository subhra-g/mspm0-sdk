...
In this example, the inference happens using the Neural Processing Unit (NPU) hardware accelerator, thus making it faster compared to using the M0+ CPU to perform the same task.
...
| Flash Usage | 5.14 kB |
| RAM Usage | 12.68 kB |
| Inference Latency (CPU) | 1087.98 ms |
