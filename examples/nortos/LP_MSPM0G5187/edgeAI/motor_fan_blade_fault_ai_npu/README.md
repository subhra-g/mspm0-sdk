...
| --- | --- |
| Accuracy | ~99% |
| Flash Usage | 2.178 kB |
| RAM Usage | 0.880 kB |
| Inference Latency (NPU) | 0.163 ms |

*Note: Performance metrics to be measured on LP-MSPM0G5187.*
...
2. **Operation**
   ...
   - Extracted features are fed to the AI model for hardware-accelerated inference.
...
- **AI Inference**: Runs a pre-trained MLP model using TVM runtime with TinyEngine™ NPU acceleration.
