...
MSPM0 LaunchPad, please visit the [LP-MSPM0G3218 User's Guide](https://www.ti.com/tool/LP-MSPM0G3218#tech-docs).

## Example Usage

Connect SPI_PICO, SPI_POCI, SPI_CLK, SPI_CS with the BSL Host (any microcontroller with SPI).
