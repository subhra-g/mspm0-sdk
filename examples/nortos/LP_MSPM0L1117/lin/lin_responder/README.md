...
LP-MSPM0L1117 LaunchPad. It showcases SUBSCRIBE frames (receive from commander),
...
### Hardware Setup
Connect the LP-MSPM0L1117 LaunchPad to a LIN Commander or Network Analyzer via a
...
LP-MSPM0L1117 LaunchPad as the UART connector pins do not support LIN mode.
