...
generate the random seed values for ML-KEM-768.  From the seed values, ML-KEM-768
...
sequence.  In a real world application, ML-KEM-768 would be used by two processors/systems
