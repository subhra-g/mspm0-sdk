...
LP-MSPM0L1306 LaunchPad. It showcases SUBSCRIBE frames (receive from commander),
...
indicates successful packet reception (LED Red) and transmission (LED Blue), with
...
### Hardware Setup
Connect the LP-MSPM0L1306 LaunchPad to a LIN Commander or Network Analyzer. The
BOOSTXL-CANFD-LIN BoosterPack is compatible with this LaunchPad and can be stacked directly:
...
1. **PID 0x10 (SUBSCRIBE)**:
   ...
   - LED Red (PA26) pulses briefly on successful reception
...
2. **PID 0x20 (PUBLISH)**:
   ...
   - LED Blue (PA27) pulses briefly on successful transmission
