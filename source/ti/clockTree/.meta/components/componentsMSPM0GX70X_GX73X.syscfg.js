...
let M0GX70X_Full_Entries = M0GX70X_Simple_Entries.concat([
	"FCC",
	"FCCEXT",
	"FCCSELCLKMUX",
	"FCCTRIGMUX",
...
let M0GX70X_CLK_OUT_FCC_Entries = [
	// input nets
	"net_sysosc",
	"net_ulpclk",
	"net_lfclk",
...
let M0GX70X_Peripherals = [
	"TIMG0"
];


let M0GX70X_Simple_reasonableLayout = {
...
let M0GX70X_Full_AdditionalLayout = {
...
let M0GX70X_CLK_OUT_FCC_Layout = {
...
let M0GX70X_Simple_BrokenConnections = [
...
let M0GX70X_EXT_BrokenConnections = [
...
let M0GX70X_Full_BrokenConnections = [
...
let full_layout = Object.assign(M0GX70X_Full_AdditionalLayout, M0GX70X_Simple_reasonableLayout);

const M0GX70XGATESimple = [
...
const M0GX70XGATEEXT = [
	"net_mclk", "net_sysosc", "net_lfclk", "net_hfclk", "net_mfpclkGate",
	"net_syspll1", "net_ulpclk", "net_exclk", "net_syspll0", "net_syspll2x"
];

exports = {
    entriesSimple: M0GX70X_Simple_Entries,
    layoutSimple: M0GX70X_Simple_reasonableLayout,
	brokenConnectionsSimple: M0GX70X_Simple_BrokenConnections,
	freqLabelSimple: M0GX70XGATESimple,
	entriesFull: [],
	layoutFull: full_layout,
	brokenConnectionsFull: Object.assign(M0GX70X_Full_BrokenConnections, M0GX70X_Simple_BrokenConnections),
	entriesEXT: M0GX70X_CLK_OUT_FCC_Entries,
	freqLabelEXT: M0GX70XGATEEXT,
	layoutEXT: M0GX70X_CLK_OUT_FCC_Layout,
	brokenConnectionsEXT: M0GX70X_EXT_BrokenConnections
}
